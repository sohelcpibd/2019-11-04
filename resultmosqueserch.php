<?php
include "mosquesearching.php";
    $conn= mysqli_connect("localhost","root","","mosqueinfo");
    $sql="SELECT * FROM mosque_info where street="$stret" AND community="$comunty" AND district="distr"";
...
<html lang="en">
                <head>
                    ...
                    <script type="text/javascript">
                      ...
                      var comunty = document.getElementById("community");
                      var distr = document.getElementById("district");
